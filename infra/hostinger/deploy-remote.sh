...
runtime_env_keys=(
  ...
  OPENROUTER_BASE_URL
  DEFAULT_MODEL
  TRANSMUTER_AI_RUNTIME
  TRANSMUTER_HERMES_IMAGE
  HERMES_BASE_URL
  HERMES_API_SERVER_KEY
  HERMES_MODEL
  HERMES_TIMEOUT_SECONDS
  HERMES_MAX_RETRIES
  HERMES_FALLBACK_TO_BASIC
  HERMES_TOOL_TOKEN
  HERMES_CONTEXT_SIGNING_SECRET
  HERMES_CONTEXT_TTL_SECONDS
  HERMES_OPENROUTER_API_KEY
  TRANSMUTER_HERMES_REFRESH_PROFILE
  LANGFUSE_SECRET_KEY
  LANGFUSE_PUBLIC_KEY
  LANGFUSE_HOST
  LOGFIRE_TOKEN
