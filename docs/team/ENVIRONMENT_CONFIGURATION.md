...
| `TRANSMUTER_E2E_PASSWORD` | Tests | No default | Seeded test user password. Load it from the ignored, mode-`0600` repository-root `credentials.json` file or an ephemeral environment variable; never commit a real value. |
