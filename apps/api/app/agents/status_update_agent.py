...
def draft_status_update(context: InitiativeContextPullResult) -> StatusUpdateDraftSuggestion:
    ...
    summary = (
        ...
        f"{risks.open_high} high risks and {risks.open_medium} medium risks open, and "
...
def _confidence(context: InitiativeContextPullResult) -> float:
    ...
    if context.last_update:
        score += 0.08
    if (
        context.financials_summary.revenue_plan != "0.0000"
        or context.financials_summary.costs_plan != "0.0000"
    ):
        score += 0.05
