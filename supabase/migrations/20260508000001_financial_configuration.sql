...
FROM (
  ...
  JOIN (
    VALUES
      ...
      ('gross_margin','gm_uplift_base','GM Uplift (Base)','metric','gm_uplift_base','benefit',10),
      ('gross_margin','gm_uplift_high','GM Uplift (High)','metric','gm_uplift_high','benefit',20),
      ('gross_margin','gm_uplift_actual','GM Uplift (Actual)','metric','gm_uplift_actual','benefit',30),
      ...
      ('operating','software','Software / Licenses','cost_category',NULL,'recurring_cost',10),
      ('operating','labor','Labor / Operations','cost_category',NULL,'recurring_cost',20),
